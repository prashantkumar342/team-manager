    ...
    <div className="min-h-screen  flex items-center justify-center p-4 sm:p-6 lg:p-8">
      <div className="w-full max-w-4xl">
        <div className="text-center mb-8 sm:mb-12">
          ...
          <h1 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-foreground mb-2">Get Started</h1>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
          ...
          >
            <CardContent className="p-6 sm:p-8">
              ...
              <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-2 sm:mb-3">Create Team</h2>
              <p className="text-sm sm:text-base text-muted-foreground">Start fresh and invite members</p>
            </CardContent>
          </Card>

          <Card className="hover:border-primary/50 transition-all duration-300 cursor-pointer group" onClick={() => setJoinTeamModal(true)}>
            <CardContent className="p-6 sm:p-8">
              <div className="flex items-center justify-center w-12 h-12 sm:w-14 sm:h-14 bg-primary/10 rounded-xl mb-4 sm:mb-6 group-hover:bg-primary/20 transition-colors">
                <UserPlus className="w-6 h-6 sm:w-7 sm:h-7 text-primary" />
              </div>
              <h2 className="text-xl sm:text-2xl font-semibold text-foreground mb-2 sm:mb-3">Join Team</h2>
